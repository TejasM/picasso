...
__author__ = 'tmehta'
emails = {"Children's Garden Nursery School": "info@childrensgarden.ca",
          ...
          "Rocking Horse Montessori and Nursery": "info@rockinghorsedaycare.ca",
          "Unicorn Day Care": "info@unicorndaycare.com",
          "Nuf House": "info@nufhouse.com",
          ...
          "Ashworth Preschool and Kindergarten Summer Camp": "cheryl.batty@utoronto.ca",
          "Uptown Yonge Preschool & Child Development Centre": "registrar@uptownyongepreschool.com"}

base_url = 'http://www.helpwevegotkids.com'
url = 'http://www.helpwevegotkids.com/toronto/listings/education/preschools?page='
...
tutoring_tag = Tag.objects.get_or_create(tag_name='Preschool', parent_tag=education_tag[0])
nursery_tag = Tag.objects.get_or_create(tag_name='Nursery', parent_tag=education_tag[0])
daycare_tag = Tag.objects.get_or_create(tag_name='Daycare', parent_tag=education_tag[0])
...
for i in range(1, 4):
    ...
    for listing in listings:
        ...
        if Listing.objects.filter(scraped_url=scraped_url).count() == 0:
            ...
            l.tags = [education_tag[0].id, tutoring_tag[0].id, nursery_tag[0].id, daycare_tag[0].id]
            l.save()