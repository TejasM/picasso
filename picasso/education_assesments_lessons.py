...
__author__ = 'tmehta'
emails = {"Chesnie Cooper Psychology Professional Corp.": "chesniecooper@bellnet.ca",
          "Assessment, Counselling & Coaching Centre; Dr S Jane Margles": "jmargles@rogers.com"}

base_url = 'http://www.helpwevegotkids.com'
url = 'http://www.helpwevegotkids.com/toronto/listings/education/educational-assessments?page='
...
tutoring_tag = Tag.objects.get_or_create(tag_name='Education Assessment', parent_tag=education_tag[0])
