...
__author__ = 'tmehta'
emails = {"National Rhythmic Gymnastics Centre": "info@nationalrg.ca",
          "Mini-Nastics": "mininastics@gmail.com",
          "Just Bounce Trampoline Club Inc": "info@justbounce.ca",
          "Kidnasium": "info@kidnasium.ca",
...
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/gymnastics--trampoline?page='
...
golf = Tag.objects.get_or_create(tag_name='Gymnastics', parent_tag=tag[0])
