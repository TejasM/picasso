...
__author__ = 'tmehta'
emails = {"Rocking Horse Montessori and Nursery": "info@rockinghorsedaycare.ca",
...
url = 'http://www.helpwevegotkids.com/toronto/listings/education/montessori?page='
...
tutoring_tag = Tag.objects.get_or_create(tag_name='Montessori', parent_tag=education_tag[0])
