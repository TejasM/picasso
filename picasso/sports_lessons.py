...
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/basketball-baseball-and-soccer?page='
...
basketball = Tag.objects.get_or_create(tag_name='Basketball')
soccer = Tag.objects.get_or_create(tag_name='Soccer')
baseball = Tag.objects.get_or_create(tag_name='Baseball')
