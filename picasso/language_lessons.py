...
__author__ = 'tmehta'
emails = {"Wise Adventures": "mail@wise-adventures.ca",
          "Oraynu Children's School": "roby@oraynu.org",
          "Hands on Exotics": "del@handsonexotics.com",
...
url = 'http://www.helpwevegotkids.com/toronto/listings/education/languages--specialty-programs?page='
...
language_tag = Tag.objects.get_or_create(tag_name='Language', parent_tag=education_tag[0])
speciality_tag = Tag.objects.get_or_create(tag_name='Speciality Programs', parent_tag=education_tag[0])
...
for i in range(1, 2):
    ...
    for listing in listings:
        ...
        if Listing.objects.filter(scraped_url=scraped_url).count() == 0:
            ...
            l.tags = [education_tag[0].id, language_tag[0].id, speciality_tag[0].id]
            l.save()