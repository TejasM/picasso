...
language_tag = Tag.objects.get_or_create(tag_name='Language', parent_tag=education_tag)
speciality_tag = Tag.objects.get_or_create(tag_name='Speciality Programs', parent_tag=education_tag)
