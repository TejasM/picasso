...
__author__ = 'tmehta'
emails = {"Lytton Sports Camps": "info@lyttonsportscamps.com"}

base_url = 'http://www.helpwevegotkids.com'
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/tennis?page='
...
golf = Tag.objects.get_or_create(tag_name='Tennis', parent_tag=tag[0])
