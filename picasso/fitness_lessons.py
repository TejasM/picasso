...
__author__ = 'tmehta'
emails = {"Sportplay": "registration@sportplay.ca",
          "Prema Yoga": "jenny@premayogatoronto.com",
          "ViBE Dance & Fitness Studio": "info@vibestudio.ca"}

base_url = 'http://www.helpwevegotkids.com'
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/fitness-for-kids?page='
