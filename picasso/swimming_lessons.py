...
__author__ = 'tmehta'
emails = {"Mobile Aquatics": "mobileaquatics@ymail.com",
          "AquaMobile Swim School - Lessons in your Home": "info@aquamobileswim.com",
          "Aquastars Swim School": "brenna@aquastars.ca",
          "Davina's Swim House": "Info@davinasswimhouse.com",
          "North York Aquatic Club": "nyacinfo@gmail.com",
          "Toronto Summer Swim Camp": "bobhayes_@me.com"}

base_url = 'http://www.helpwevegotkids.com'
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/swimming?page='
...
golf = Tag.objects.get_or_create(tag_name='Swimming', parent_tag=tag[0])
