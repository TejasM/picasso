...
url = 'http://www.helpwevegotkids.com/toronto/listings/education/educational-resources?page='
...
tutoring_tag = Tag.objects.get_or_create(tag_name='Education Resource', parent_tag=education_tag[0])
