...
__author__ = 'tmehta'
emails = {"North Toronto Karate Schools": "mikepalitti@rogers.com",
          "High Park Karate by North Toronto Karate School": "mikepalitti@rogers.com",
          "Northern Karate Schools": "",
          "Synergy Martial Arts": "Info@synergymartialarts.ca",
          "Takedown MMA": "info@takedownmma.ca",
          "Chu's Martial Arts World": "chusmartialarts@gmail.com"}

base_url = 'http://www.helpwevegotkids.com'
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/martial-arts?page='
...
golf = Tag.objects.get_or_create(tag_name='Martial Arts', parent_tag=tag[0])
karate = Tag.objects.get_or_create(tag_name='Karate', parent_tag=tag[0])
...
for i in range(1, 4):
    ...
    for listing in listings:
        ...
        if Listing.objects.filter(scraped_url=scraped_url).count() == 0:
            ...
            l.tags = [tag[0].id, golf[0].id, karate[0].id]
            l.save()