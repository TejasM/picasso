...
url = 'http://www.helpwevegotkids.com/toronto/listings/education/special-education?page='
...
tutoring_tag = Tag.objects.get_or_create(tag_name='Special Education', parent_tag=education_tag[0])
