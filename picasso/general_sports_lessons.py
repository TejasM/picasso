...
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/sports-associations?page='
...
golf = Tag.objects.get_or_create(tag_name='Other Sports Associations', parent_tag=tag[0])
