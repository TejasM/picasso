...
__author__ = 'tmehta'
emails = {"North Beach Indoor Volleyball and Rock Climbing": "info@northbeachvolleyball.com",
          "Sportplay": "registration@sportplay.ca",
          "RINX": "birthdays@rinxtoronto.com",
          "Sky Zone Indoor Trampoline Park - Toronto": "dbuttiglieri@skyzonesports.com"}

base_url = 'http://www.helpwevegotkids.com'
url = 'http://www.helpwevegotkids.com/toronto/listings/sports/general-sports--multi-sports-centres?page='
...
golf = Tag.objects.get_or_create(tag_name='Indoor Sports', parent_tag=tag[0])
